    ...
    <div className="my-10">
      <div className="text-center text-3xl py-8">
        ...
        <p className="w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600">
          ...
          unde qui maiores neque doloribus maxime laborum repellendus, quasi
          quos asperiores debitis rerum, quod provident odit minus eaque.
          Commodi, ex.sdergdfvwefwef
        </p>
      </div>
